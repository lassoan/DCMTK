...
#ifndef DCMJP2K_DJ2KUTIL_H
#define DCMJP2K_DJ2KUTIL_H

#include "dcmtk/config/osconfig.h"
#include "dcmtk/ofstd/ofcond.h"   /* for class OFCondition */
#include "dcmtk/oflog/oflog.h"
#include "dcmtk/dcmjp2k/dj2kdefine.h"


// global definitions for logging mechanism provided by the oflog module

extern DCMTK_DCMJP2K_EXPORT OFLogger DCM_dcmjp2kLogger;
...
extern DCMTK_DCMJP2K_EXPORT const OFConditionConst EC_J2KUncompressedBufferTooSmall;

/// error condition constant: Too small buffer used for compressed image data (internal error)
extern DCMTK_DCMJP2K_EXPORT const OFConditionConst EC_J2KCompressedBufferTooSmall;

/// error condition constant: The image uses some features which the codec does not support
extern DCMTK_DCMJP2K_EXPORT const OFConditionConst EC_J2KCodecUnsupportedImageType;

/// error condition constant: The codec was fed with invalid parameters (e.g. height = -1)
extern DCMTK_DCMJP2K_EXPORT const OFConditionConst EC_J2KCodecInvalidParameters;

/// error condition constant: The codec was fed with unsupported parameters (e.g. 32 bit per sample)
extern DCMTK_DCMJP2K_EXPORT const OFConditionConst EC_J2KCodecUnsupportedValue;

/// error condition constant: The compressed image is invalid
extern DCMTK_DCMJP2K_EXPORT const OFConditionConst EC_J2KInvalidCompressedData;

/// error condition constant: Unsupported bit depth in JPEG 2000 transfer syntax
extern DCMTK_DCMJP2K_EXPORT const OFConditionConst EC_J2KUnsupportedBitDepth;

/// error condition constant: Cannot compute number of fragments for JPEG 2000 frame
extern DCMTK_DCMJP2K_EXPORT const OFConditionConst EC_J2KCannotComputeNumberOfFragments;

/// error condition constant: Image data mismatch between DICOM header and JPEG 2000 bitstream
extern DCMTK_DCMJP2K_EXPORT const OFConditionConst EC_J2KImageDataMismatch;

/// error condition constant: Unsupported photometric interpretation for JPEG 2000 compression
extern DCMTK_DCMJP2K_EXPORT const OFConditionConst EC_J2KUnsupportedPhotometricInterpretation;

/// error condition constant: Unsupported pixel representation for JPEG 2000 compression
extern DCMTK_DCMJP2K_EXPORT const OFConditionConst EC_J2KUnsupportedPixelRepresentation;

/// error condition constant: Unsupported type of image for JPEG 2000 compression
extern DCMTK_DCMJP2K_EXPORT const OFConditionConst EC_J2KUnsupportedImageType;

/// error condition constant: OpenJPEG library not available
extern DCMTK_DCMJP2K_EXPORT const OFConditionConst EC_J2KOpenJPEGNotAvailable;
